...
public class FactorialParallelSwing implements IFactorialFunction {
    ...
    private static final int SMALLSWING = 33;
    private static final int SMALLFACT = 17;
    ...
    private static final int[] smallOddSwing = {1, 1, 1, 3, 3, 15, 5, 35, 35, 315, 63, 
    ...
    private static final int[] smallOddFactorial = {1, 1, 1, 3, 3, 15, 45, 315, 315, 
